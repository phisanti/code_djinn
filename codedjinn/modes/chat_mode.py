...
class ChatMode(BaseMode):
    ...
    def __init__(self, llm_instance, provider: str, os_fullname: str, shell: str, 
                 system_prompt_preferences: str = "", shell_path: str = ""):
        ...
        self.chat_prompt_builder = build_chat_prompt(os_fullname, shell, system_prompt_preferences)
    ...
    def _process_input(self, user_input: str):
        ...
        try:
            ...
            self.parameter_manager.apply_parameters(self.llm, self.provider, explain=False)
    ...
    def _handle_response(self, parsed: dict, user_input: str):
        ...
        if parsed['type'] == 'answer':
            ...
            # Update context
            context_entry = parsed['answer'] if parsed['answer'] else "[generated command]"
        ...
        while len(self.conversation_context) > self.max_context:
            ...
            if self.conversation_context and not self.conversation_context[0].startswith('User:'):
