...
def build_chat_prompt(os_fullname: str, shell: str, system_prompt_preferences: str = "") -> PromptBuilder:
    """
    ...
    return PromptBuilder(template=template, input_variables=["current_dir", "context", "user_input"])